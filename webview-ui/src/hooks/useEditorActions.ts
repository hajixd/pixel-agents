...
export interface EditorActions {
  ...
  handleOpenAgent: (provider?: 'claude' | 'codex') => void
...
export function useEditorActions(
  ...
  const handleOpenAgent = useCallback((provider?: 'claude' | 'codex') => {
    vscode.postMessage({ type: 'openAgent', provider, useDeskMapping: true })
  }, [])
